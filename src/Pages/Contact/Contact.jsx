              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                  >
                    <p className="text-gray-900">Drabya Raj Chaudhary</p>
                    <p className="text-gray-500 text-sm">Executive Director</p>
                  </motion.div>
                  <motion.div
                    className="group"
                    whileHover={{ x: 4 }}
                    transition={{ duration: 0.2 }}
                  >
                    <p className="text-gray-900">Govind Chaudhary</p>
                    <p className="text-gray-500 text-sm">Program Coordinator</p>
                  </motion.div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-gray-600">
                  ...
                  >
                    <MapPin className="w-5 h-5 mt-1 text-gray-400 group-hover:text-gray-900 transition-colors duration-300" />
                    <span>
                      Gairigaun-9, Sinamangal Near Airport Cargo Office,
                      Kathmandu
                    </span>
                  </motion.div>
                  <motion.div
