...
const ExecutiveCommittee = () => {
  const boardMembers = [
    {
      name: "Bhagbati Chaudhary",
      qualification: "B.Com, M.A (Socio)",
      post: "Chairperson",
    ...
    {
      name: "Jayanti Rai",
      qualification: "M.A. (Eco)",
      post: "General Secretary",
      location: "Jitpur, Ilam",
    },
    {
    ...
    {
      name: "Dev Kumari Shrestha",
      qualification: "B.Com., M.Sc. (Nur)",
      post: "Member",
      location: "Dharan, Sunsari",
    },
    {
      name: "Kalawati Chaudhary",
      qualification: "S.L.C.",
      post: "Member",
      location: "Sunsari",
    },
    {
      name: "Navodita Chaudhary",
      qualification: "M.Sc (NRM)",
      post: "Member",
    ...
    {
      name: "Aash Narayan Chaudhary",
      qualification: "M.Sc",
      post: "Executive Director",
      location: "Aurabani, Sunsari",
    },
  ];
      ...
      <div className=" mx-auto py-12  space-y-12">
        ...
        <div className="text-center space-y-4  mt-[70px] md:mt-[100px]">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            Learn more about our agency and the dedicated team behind our
            success.
          </p>
        </div>
        <div className="px-6 lg:px-[7rem]">
          ...
          <div className="space-y-6">
            <div className="max-w-3xl">
              ...
              <p className="text-gray-600 leading-relaxed">
                Board/Executive Committee focused to supervise Operation heads,
                internal audit management and other management working with
                team. The team manage the regular supervision, monitoring and
                follow-up of Group, Center units and Branch offices, for staff's
                efficiency promotion. Moreover, board itself regulate the
                policies and enhance new techniques, principle of micro-finance
            ...
            <div className="mt-8">
              <p className="text-sm uppercase tracking-wider text-gray-500 mb-6">
                New Elected Board Members from 15th AGM, 2067
              </p>
          ...
          <div className="space-y-6 mt-[4rem]">
            <div className="max-w-3xl">
              ...
              <p className="text-gray-600 leading-relaxed">
                Central and Area management team assist in operation and
                feedback of field performance in Center/ Units and all over the
                branches and staffs.
              </p>
            </div>
